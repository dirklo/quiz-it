...
#####QUIZ 1#####
question = quiz1.questions.create(content: "Is a hot dog a sandwich?", kind: "mc_one", limit: 2, order: 1)
question.answers.create(content: "Yes", correct: false, order: 1)
question.answers.create(content: "No", correct: true, order: 2)

question = quiz1.questions.create(content: "Which of these toppings does not belong on pizza?", kind: "mc_one", limit: 4, order: 2)
...
question = quiz1.questions.create(content: "Which of these are fruits? (select all that apply)", kind: "mc_many", limit: 6, order: 3)
...
#####QUIZ 2#####
question = quiz2.questions.create(content: "All dogs are descended from what animal?", kind: "mc_one", limit: 5, order: 1)
...
question = quiz2.questions.create(content: "How many legs does a spider have?", kind: "mc_one", limit: 3, order: 2)
...
#####QUIZ 3#####
question = quiz3.questions.create(content: "Which of these is a string instrument?", kind: "mc_one", limit: 5, order: 1)
...
question = quiz3.questions.create(content: "The drums are part of which family?", kind: "mc_one", limit: 4, order: 3)
...
#####QUIZ 5#####
question = quiz5.questions.create(content: "What does a user utilize to interact with the web?", kind: "mc_one", limit: 4, order: 1)
...
question = quiz5.questions.create(content: "What do we call the datatype consisting of an ordered set of characters, delineated by quotation marks?", kind: "mc_one", limit: 4, order: 2)
...
question = quiz5.questions.create(content: "What are the 3 parts of MVC? (select all that apply)", kind: "mc_many", limit: 9, order: 3)
...
#####QUIZ 6#####
question = quiz6.questions.create(content: "Which of these cocktails typically include vodka?", kind: "mc_one", limit: 4, order: 1)
...
question = quiz6.questions.create(content: "How many ounces of spirit should a martini contain?", kind: "mc_one", limit: 3, order: 2)
...
question = quiz7.questions.create(content: "Which is the worlds most common vegetable?", kind: "mc_one", limit: 4, order: 2)
question.answers.create(content: "Tomato", correct: true)
question.answers.create(content: "Onion", correct: false)
question.answers.create(content: "Cucumber", correct: false)
question.answers.create(content: "Cabbage", correct: false)

question = quiz7.questions.create(content: "Mushrooms have their own immune system.", kind: "mc_one", limit: 2, order: 3)
question.answers.create(content: "True", correct: true)
question.answers.create(content: "False", correct: false)

#####QUIZ 8#####
question = quiz8.questions.create(content: "Which of these characters is blue, runs fast, and collects rings?", kind: "mc_one", limit: 4, order: 1)
...
question = quiz8.questions.create(content: "in GTA: San Andreas, what does 'GTA' Stand for?", kind: "mc_one", limit: 4, order: 3)
